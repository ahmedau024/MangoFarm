...
const Register = () => {
  ...
  return (
    <>
      <PageTransition>
        <Toaster richColors />
        <div className=" inset-0 z-50 overflow-auto bg-slate-200 flex justify-center h-screen items-center">
          <div className="m-36 bg-white rounded-sm px-16 max-w-md mx-auto shadow-lg">
            <h1 className="pt-10 text-2xl">Sign Up to for an account</h1>
            <form
            ...
            >
              ...
              <div className="text-md md:text-lg space-x-5 flex mt-2">
